...
<h1>उच्चमाध्यमिक विभाग - दैनंदिन आहार योजना</h1>
<form id="grain_form">
...
<tr>
  ...
  <tr>
	<td>11<input type="text" size="3" name="oneToFive" value="0" onchange="oneToFivePresent();"></td>
	<td>सकाळ</td>
  ...
  <tr>
	<td>12<input type="text" size="3" name="sixToSeven" value="0" onchange="sixToSevenPresent();"></td>
	<td>संध्या</td>
  ...
  <tr>
	...
	<td colspan="37"><button type='button' class='btn'  onclick="submitData();">जमा करा</button>&nbsp;
...
<script type="text/javascript" src='<?php echo base_url(); ?>assets/js/insertHigherSecDataJS.js'></script>
<script type="text/javascript" src='<?php echo base_url(); ?>assets/js/higherSecondaryCalJS.js'></script>
</html>
