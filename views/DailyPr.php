...
<h1>प्राथमिक विभाग - दैनंदिन आहार योजना</h1>
<form id="grain_form">
...
<select name="year" id="year"> 
  ...
  <tr>
	...
	<td><input type="text" size="6" name="rem1_srpan" value="0.0" onchange="totalRemSarpan();"></td>
	<td><input type="text" size="3" name="rem1_tikhat" value="0.0"  onchange="totalRemTikhat();"></td>
	<td><input type="text" size="3"  name="rem1_hld" value="0.0" onchange="totalRemHalad();"></td>
	<td><input type="text" size="3" name="rem1_jira" value="0.0" onchange="totalRemJira();"></td>
	<td><input type="text" size="3"  name="rem1_masala" value="0.0" onchange="totalRemMasala();"></td>
	<td><input type="text" size="3"  name="rem1_salt" value="0.0" onchange="totalRemSalt();"></td>
	<td><input type="text" size="3"  name="rem1_shengdana" value="0.0" onchange="totalRemShengdana();"></td>
	<td><input type="text" size="3"  name="rem1_sugar" value="0.0" onchange="totalRemSugar();"></td>
	<td><input type="text" size="3"  name="rem1_fa_oil" value="0.0" onchange="totalRemFaOil();"></td>
	<td><input type="text" size="3"  name="rem1_matki" value="0.0" onchange="totalRemMataki();"></td>
	<td><input type="text" size="3"  name="rem1_barbiti" value="0.0" onchange="totalRemBarbiti();"> </td>
	<td><input type="text" size="3"  name="rem1_chna" value="0.0" onchange="totalRemChana();"></td>
	<td><input type="text" size="3"  name="rem1_ka_soap" value="0.0" onchange="totalRemKaSoap();"></td>
	<td><input type="text" size="5"  name="rem1_a_soap" value="0.0" onchange="totalRemASoap();"></td>
	<td><input type="text" size="5" name="rem1_kho_oil" value="0.0" onchange="totalRemKhoOil();"></td>

	<td><input type="text" size="3" name="rem1_majan" value="0.0" onchange="totalRemMajan();"></td>
	<td><input type="text" size="3" name="rem1_eggs" value="0.0" onchange="totalRemEggs();"></td>
	<td><input type="text" size="3" name="rem1_fruits" value="0.0" onchange="totalRemFruits();"> </td>
	<td><input type="text" size="3" name="rem1_mutton" value="0.0" onchange="totalRemMutton();"></td>
	<td><input type="text" size="3"  name="rem1_fist" value="0.0" onchange="totalRemFist();"></td>
	<td><input type="text" size="3"  name="rem1_milk" value="0.0" onchange="totalRemMilk();"></td>
	<td><input type="text" size="6" name="rem1_vegetables1"  value="0.0" onchange="totalRemVegetables1();"></td>
	<td><input type="text" size="6" name="rem1_vegetables2" value="0.0" onchange="totalRemVegetables2();"></td>
	<td><input type="text" size="3" name="rem1_garlic" value="0.0" onchange="totalRemGarlic();"></td>
	<td><input type="text" size="3" name="rem1_onion" value="0.0" onchange="totalRemOnion();"></td>
...
<tr>
    <td rowspan="7"><input type="date" name="date" id="date" ><br>
  ...
  <tr>
	...
	<td><input type="text" size="6" name="in_srpan" value="0.0" onchange="totalInSarpan();"></td>
	<td><input type="text" size="3" name="in_tikhat" value="0.0" onchange="totalInTikhat();"></td>
	<td><input type="text" size="3"  name="in_hld" value="0.0" onchange="totalInHalad();"></td>
	<td><input type="text" size="3" name="in_jira" value="0.0" onchange="totalInJira();"></td>
	<td><input type="text" size="3"  name="in_masala" value="0.0" onchange="totalInMasala();"></td>
	<td><input type="text" size="3"  name="in_salt" value="0.0" onchange="totalInSalt();"></td>
	<td><input type="text" size="3"  name="in_shengdana" value="0.0" onchange="totalInShengdana();"></td>
	<td><input type="text" size="3"  name="in_sugar" value="0.0" onchange="totalInSugar();"></td>
	<td><input type="text" size="3"  name="in_fa_oil" value="0.0" onchange="totalInFaOil();"></td>
	<td><input type="text" size="3"  name="in_matki" value="0.0" onchange="totalInMataki();"></td>
	<td><input type="text" size="3"  name="in_barbiti" value="0.0" onchange="totalInBarbiti();"></td>
	<td><input type="text" size="3"  name="in_chna" value="0.0" onchange="totalInChana();"></td>
	<td><input type="text" size="3"  name="in_ka_soap" value="0.0" onchange="totalInKaSoap();"></td>
	<td><input type="text" size="5"  name="in_a_soap" value="0.0" onchange="totalInASoap();"></td>
	<td><input type="text" size="5" name="in_kho_oil" value="0.0" onchange="totalInKhoOil();"></td>
	<td><input type="text" size="3" name="in_majan" value="0.0" onchange="totalInMajan();"></td>
	<td><input type="text" size="3" name="in_eggs" value="0.0" onchange="totalInEggs();"></td>
	<td><input type="text" size="3" name="in_fruits" value="0.0" onchange="totalInFruits();"></td>
	<td><input type="text" size="3" name="in_mutton" value="0.0" onchange="totalInMutton();"></td>
	<td><input type="text" size="3"  name="in_fist" value="0.0" onchange="totalInFist();"></td>
	<td><input type="text" size="3"  name="in_milk" value="0.0" onchange="totalInMilk();"></td>
	<td><input type="text" size="6" name="in_vegetables1" value="0.0" onchange="totalInVegetables1();"></td>
	<td><input type="text" size="6" name="in_vegetables2" value="0.0" onchange="totalInVegetables2();"></td>
	<td><input type="text" size="3" name="in_garlic" value="0.0" onchange="totalInGarlic();"></td>
	<td><input type="text" size="3" name="in_onion" value="0.0" onchange="totalInOnion();"></td>
  ...
  <tr>
	<td>पट <input type="text" size="3" name="attendance" value="0"></td>
	<td>एकूण</td>
  ...
  <tr>
	<td>1ते5  <input type="text" size="3" name="oneToFive" value="0" onchange="oneToFivePresent();"></td>
	<td>सकाळ</td>
  ...
  <tr>
	<td>6ते7  <input type="text" size="3" name="sixToSeven" value="0"  onchange="sixToSevenPresent();"></td>
	<td>	संध्या</td>
	...
	<tr>
	<td rowspan="2">एकूण हजर  <input type="text" size="3" size="3" name="totalAttendence" value="0"></td>
	<td>एकूण</td>
...
<script type="text/javascript" src='<?php echo base_url(); ?>assets/js/insertDataJS.js'></script>
<script type="text/javascript" src='<?php echo base_url(); ?>assets/js/PrimaryCalJS.js'></script>
