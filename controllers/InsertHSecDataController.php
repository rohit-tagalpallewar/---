<?php 
  class InsertHSecDataController extends CI_Controller {


   public function __construct() {
        parent::__construct();
        $this->load->model('InsertHigherSecDataModel');   
    ...
    public function checkInsertedData(){
      ...
      $check_inserted_data= $this->InsertHigherSecDataModel->CheckInsertedData($insertDataArray);
        ...
        $rem2_pohe = $this->input->post('rem2_pohe');
         ...
         $primaryAttendenceData= array(
           ...
           'year' => $year,
              ...
              'classElevenPresent' => $oneToFive,
                 'classTwelvePresent' => $sixToSeven,
                     
             'total' => $totalAttendence
           );

        $query_res = $this->InsertHigherSecDataModel->insertData($data);
         $IncomeData = $this->InsertHigherSecDataModel->insertIncomeData($income_Data);
         $Total1Data = $this->InsertHigherSecDataModel->insertTotal1Data($total1_data);
         $MorningData = $this->InsertHigherSecDataModel->insertMorningData($morning_data);
         $EveningData = $this->InsertHigherSecDataModel->insertEveningData($evening_data);
         $Total2Data = $this->InsertHigherSecDataModel->insertTotal2Data($total2_data);
         $Remaining2Data = $this->InsertHigherSecDataModel->insertRemaining2Ddata($remaining2_data);
         $primaryAttendenceData = $this->InsertHigherSecDataModel->insertPrimaryAttendenceData($primaryAttendenceData);
      ...
      function updateData(){
        ...
        $rem2_onion = $this->input->post('rem2_onion');
         ...
         $primaryAttendenceData= array(
          ...
          $query_res = $this->InsertHigherSecDataModel->updateData($data);
          $IncomeData = $this->InsertHigherSecDataModel->updateIncomeData($income_Data);
          $Total1Data = $this->InsertHigherSecDataModel->updateTotal1Data($total1_data);
          $MorningData = $this->InsertHigherSecDataModel->updateMorningData($morning_data);
          $EveningData = $this->InsertHigherSecDataModel->updateEveningData($evening_data);
          $Total2Data = $this->InsertHigherSecDataModel->updateTotal2Data($total2_data);
         $Remaining2Data = $this->InsertHigherSecDataModel->updateRemaining2Ddata($remaining2_data);
          $primaryAttendenceData = $this->InsertHigherSecDataModel->updatePrimaryAttendenceData($primaryAttendenceData);
