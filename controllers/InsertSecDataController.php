<?php 
  class InsertSecDataController extends CI_Controller {


   public function __construct() {
        parent::__construct();
        $this->load->model('InsertSecDataModel');
    ...
    public function checkInsertedData(){
      ...
      $check_inserted_data= $this->InsertSecDataModel->CheckInsertedData($insertDataArray);
  ...
  public function insertData(){
       // echo $this->input->post('year');
        ...
        $rem2_pohe = $this->input->post('rem2_pohe');
         ...
         $classEightPresent = $this->input->post('oneToFive');
         $classNineToTenPresent = $this->input->post('sixToSeven');
         ...
         $primaryAttendenceData= array(
           ...
           'year' => $year,
              ...
              'classEightPresent' => $classEightPresent,
                 'classNineToTenPresent' => $classNineToTenPresent,
             'total' => $totalAttendence
           );

        $query_res = $this->InsertSecDataModel->insertData($data);
         $IncomeData = $this->InsertSecDataModel->insertIncomeData($income_Data);
         $Total1Data = $this->InsertSecDataModel->insertTotal1Data($total1_data);
         $MorningData = $this->InsertSecDataModel->insertMorningData($morning_data);
         $EveningData = $this->InsertSecDataModel->insertEveningData($evening_data);
         $Total2Data = $this->InsertSecDataModel->insertTotal2Data($total2_data);
         $Remaining2Data = $this->InsertSecDataModel->insertRemaining2Ddata($remaining2_data);
         $primaryAttendenceData = $this->InsertSecDataModel->insertPrimaryAttendenceData($primaryAttendenceData);
      ...
      function updateData(){
        ...
        $rem2_onion = $this->input->post('rem2_onion');
         ...
         $attendance = $this->input->post('attendance');
         $classEightPresent = $this->input->post('classEightPresent');
         $classNineToTenPresent = $this->input->post('classNineToTenPresent');
         ...
         $primaryAttendenceData= array(
          ...
          $query_res = $this->InsertSecDataModel->updateData($data);
          $IncomeData = $this->InsertSecDataModel->updateIncomeData($income_Data);
          $Total1Data = $this->InsertSecDataModel->updateTotal1Data($total1_data);
          $MorningData = $this->InsertSecDataModel->updateMorningData($morning_data);
          $EveningData = $this->InsertSecDataModel->updateEveningData($evening_data);
          $Total2Data = $this->InsertSecDataModel->updateTotal2Data($total2_data);
         $Remaining2Data = $this->InsertSecDataModel->updateRemaining2Ddata($remaining2_data);
          $primaryAttendenceData = $this->InsertSecDataModel->updatePrimaryAttendenceData($primaryAttendenceData);
