var f=0;
   ...
   if(datesel == '01'){
     return false;
          ...
          getRemainingData(date1);  
   }
          
        
   });
  function  getRemainingData(date1){
    var date1 = date1;
    // var selected_month = selected_month;
    // var selected_year = selected_year;
    $.ajax({
        url: baseUrl + 'getRemainingDataController/getRemainingData',
        type: 'POST',
        data: {'date1': date1},
        dataType: 'json',
...
function submitData(){
  ...
  if(f == 0){
    ...
    var errors = new Array();
      $.ajax({
        url: baseUrl + 'InsertDataController/checkInsertedData',
        type: 'POST',
        data: formdata,
        dataType: 'json',
        success: function (data) {
...
function insertData(){
    ...
    var errors = new Array();
      ...
      $.ajax({
        url: baseUrl + 'InsertDataController/insertData',
        type: 'POST',
        data: formdata,
        dataType: 'json',
        success: function (data) {
...
function  updateData(){
  var formdata = $('#grain_form').serialize();
    var errors = new Array();
      ...
      $.ajax({
        url: baseUrl + 'InsertDataController/updateData',
        type: 'POST',
        data: formdata,
        dataType: 'json',
        success: function (data) {
