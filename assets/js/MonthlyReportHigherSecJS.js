...
function showData() {
  ...
  var formdata = $('#monthlyReport_form').serialize();
    $.ajax({
        url: baseUrl + "showHigherSecDataController/showData",
        type: "POST",
        data : formdata,
        dataType: 'json',
        success: function (data) {      
            ...
            $.each(data.attendance, function (index, value) {
              ...
              var classElevenPresent,classTwelvePresent;
                  classElevenPresent = value.classElevenPresent;
                  classTwelvePresent = value.classTwelvePresent;
                 
                     if(classElevenPresent == null){
                   classElevenPresent  = 0; 
                      $('#oneToFive').html(classElevenPresent);
                  }else{
                      $('#oneToFive').html(classElevenPresent);
                  }

                  if(classTwelvePresent == null){
                     classTwelvePresent  = 0;
                     $('#sixToSeven').html(classTwelvePresent);
                   
                  }else{
                      $('#sixToSeven').html(classTwelvePresent);
                  }
                  
                  var oneToSeven = parseFloat(classElevenPresent) + parseFloat(classTwelvePresent);
                  ...
                  $("#oneToFiveAvg").html((classElevenPresent/days).toFixed(2));
                  $("#sixToSevenAvg").html((classTwelvePresent/days).toFixed(2));
...
function showGrainData(){
    var formdata = $('#monthlyReport_form').serialize();
    $.ajax({
        url: baseUrl + "showHigherSecDataController/showGrainData",
        type: "POST",
        data : formdata,
        dataType: 'json',
        success: function (data) {      
