...
function showData() {
  ...
  var formdata = $('#monthlyReport_form').serialize();
    $.ajax({
        url: baseUrl + "showSecDataController/showData",
        type: "POST",
        data : formdata,
        dataType: 'json',
        success: function (data) {      
            ...
            $.each(data.attendance, function (index, value) {
              ...
              var classEightPresent,classNineToTenPresent;
                  classEightPresent = value.classEightPresent;
                  classNineToTenPresent = value.classNineToTenPresent;
                  $("#oneToFive").html(classEightPresent);
                  $("#sixToSeven").html(classNineToTenPresent);

                     if(classEightPresent == null){
                      classEightPresent  = 0; 
                      $('#oneToFive').html(classEightPresent);
                      }else{
                      $('#oneToFive').html(classEightPresent);
                  ...
                  if(classNineToTenPresent == null){
                     classNineToTenPresent  = 0; 
                     $('#sixToSeven').html(classNineToTenPresent);
                  ...
                  var oneToSeven = parseFloat(classEightPresent) + parseFloat(classNineToTenPresent);
                  ...
                  $("#oneToFiveAvg").html((classEightPresent/days).toFixed(2));
                  $("#sixToSevenAvg").html((classNineToTenPresent/days).toFixed(2));
...
function showGrainData(){
    var formdata = $('#monthlyReport_form').serialize();
    $.ajax({
        url: baseUrl + "showSecDataController/showGrainData",
        type: "POST",
        data : formdata,
        dataType: 'json',
        success: function (data) {      
              ...
              var sixToSevenWheat = sixToSeven['wheat'];
                ...
                //grinding spend
                //  $("#grinding_spend").html(sixToSevenWheat*3); //this is wrong
