...
var f = 0;
   ...
   // var selected_year = year.value;
          ...
          getSecRemainingData(date1); 
        
   });
  function  getSecRemainingData(date1){
    var date1 = date1;
    // var selected_month = selected_month;
    // var selected_year = selected_year;
    $.ajax({
        url: baseUrl + 'getSecRemainingDataController/getRemainingData',
        type: 'POST',
        data: {'date1': date1},
        dataType: 'json',
 ...
 var date = $("input[name='date']").val();
  if(f == 0){
    ...
    var errors = new Array();
      $.ajax({
        url: baseUrl + 'InsertSecDataController/checkInsertedData',
        type: 'POST',
        data: formdata,
        dataType: 'json',
        success: function (data) {
...
function insertData(){
    ...
    var errors = new Array();
      ...
      $.ajax({
        url: baseUrl + 'InsertSecDataController/insertData',
        type: 'POST',
        data: formdata,
        dataType: 'json',
        success: function (data) {
...
function  updateData(){
  var formdata = $('#grain_form').serialize();
    var errors = new Array();
      ...
      $.ajax({
        url: baseUrl + 'InsertSecDataController/updateData',
        type: 'POST',
        data: formdata,
        dataType: 'json',
        success: function (data) {
